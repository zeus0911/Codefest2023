...
import 'package:flutter_application_1/view/bookbus/bookbustwoicon.dart';
import 'package:flutter_application_1/view/bookbus/finallybookbus.dart';
import 'package:flutter_application_1/view/topup.dart';
...
class RouteName {
  ...
  static const String finallybookbus = "BusBookingPage";
  static const String topup = "Topup";
  static const String bookbustwoicon = "BookBusTwo";
}
...
class Routes {
  static Route<dynamic> generateRoutes(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteName.bookbustwoicon:
        return MaterialPageRoute(builder: (context) => const BookBusTwo());
